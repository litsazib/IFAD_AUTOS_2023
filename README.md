...
[**This project is now archived and is no longer maintained.**](https://github.com/litsazib/IFAD_AUTOS_2023.git)
...
If you configure a .env file (just copy [.env.example](https://github.com/litsazib/IFAD_AUTOS_2023.git) over to '.env' and fill in the options) you can configure a range of options.

See the [AUTHENTICATION.md](https://github.com/litsazib/) for how to set up oAuth if you want to do that. It suggested you start with Twitter as it's the easiest to get working.
